...
path_source = "path"
path_sql_inject = "sqlmap-dev"
DEBUG = True
cookie = "user-authentication=XXXX"
...
def sql_inject_scan(*apis):
    define_dict = {"sn": "XXXXX", "ext": "no", "task_item_id": "n"}
    define_data = {"company": "dell","UserID":0, "Status":"success", "Sn":"XXXXXXX", "Username":"admin","Password":"XXXXX", "userid": 2,"Network":"192.168.1.1/24","Netmask":"255.255.255.0","Gateway":"192.168.1.1", "category": "black"}
    for api in apis:
        if "{sn}" in api["path"]:

...
from local.function.base import localConfigParser

class Database(object):
	"""docstring for Database"""
	def __init__(self, db_info):
		self.db = pymysql.connect(host=db_info["db_ip"],user=db_info["db_user"],passwd=db_info["db_pwd"],db=db_info["db_name"], port=int(db_info["db_port"]),charset = 'utf8')
